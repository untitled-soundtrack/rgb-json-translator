...
export async function doAllByCategory(categoryUrl, tasks, outputDir) {
...
export async function doEntity(url, tasks, outputDir, force = false) {
...
export function extractDate(key, outKey, jsonSnippet, output) {
...
export function extractPlace(key, outKey, jsonSnippet, output) {
  if (jsonSnippet.printouts[key].length > 0) {
...
export function extractGeoCoords(jsonSnippet, output) {
...
export function extractText(key, outKey, jsonSnippet, output) {
...
export function extractWikiEntity(key, outKey, jsonSnippet, output) {
  if (jsonSnippet.printouts[key] && jsonSnippet.printouts[key].length > 0) {
...
export function extractPersonName(outKey, jsonSnippet, output) {
  // const nameParts = {};
...
export async function extractPhotoWithTag(key, outKey, jsonSnippet, output)  {
...
export async function extractMedia(key, outKey, jsonSnippet, output)  {
  const inputUrl = jsonSnippet.printouts[key][0];
  if (inputUrl) {
...
export async function extractMedium(key, outKey, jsonSnippet, output)  {
...
export function startDateComparator(a, b) {
...
export function saveJson(filename, output) {
